...
export class TeacherService {
    ...
    register(name: string, email: string, password: string, nip: string, gelar: string, keahlian: string) {
        ...
        return this.validation.validate(schema, { name, email, password, nip, gelar, keahlian });
    }
